...
AddEventHandler("esx:tpm", function(reason)
	...
	ESX.TriggerServerCallback("esx:isUserAdmin", function(admin)
		...
		for i = Z_START, 0, -25.0 do
			...
			if found then
				...
				local actualPedCoords = GetEntityCoords(PlayerPedId())
				TriggerServerEvent('hp_logs:tpm',oldCoords, actualPedCoords,DoesBlipExist(blipMarker), reason)
				break
			end
			Wait(0)
		end 
...
local function noclipThread()
	while noclip do
		...
		--SetPedCoordsKeepVehicle(ESX.PlayerData.pednoclip_pos.x, noclip_pos.y, noclip_pos.z)
...
RegisterNetEvent('esx:teleport', function(x,y,z)
