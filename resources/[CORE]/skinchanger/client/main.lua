...
function GetMaxVals()
    ...
    local data = {
        ...
        hair_3 = #Config.HairDecorations[(GetEntityModel(playerPed) ~= `mp_f_freemode_01` and 1 or 2)],
...
function ApplySkin(skin, clothes)
    ...
    if clothes ~= nil then
        for k, v in pairs(clothes) do
            if k ~= 'sex' and k ~= 'face' and k ~= 'face2' and k ~= 'face3' and k ~= 'face_md_weight' and k ~= 'skin_md_weight' and k ~=
    ...
    SetPedHeadBlendData(playerPed, Character['face'], Character['face2'], Character['face3'], Character['skin'], Character['skin2'], Character['skin3'], Character['blend']/10, Character['skin_blend']/10, Character['blend2']/10, false)
    if Character['hair_3'] ~= 0 and Config.HairDecorations[Character['sex'] + 1] then
        local decor = Config.HairDecorations[Character['sex'] + 1][Character['hair_3']]
		if decor then
