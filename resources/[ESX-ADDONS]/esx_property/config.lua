...
Config.CanAlwaysExit = false -- Disabling this allows players to be locked in
Config.OwnerCanAlwaysEnter = false -- Disabling this means the owner can't enter the property unless door is unlocked
Config.MaxNameLength = 15 -- Max Name Length for Owned Properties Default: 20
...
Config.Raiding = {
  ...
  ItemRequired = { -- Item Required to Raid -- Remove To Disable
    ...
    name = "property_raid_pass", -- Item Name Default: "bread"
    label = "Cicha przepustka", -- Item label Default: "Bread"
...
Config.PlayerManagement = {                          
  ...
  joblabel = "Agent Nieruchomości", -- Job Label Default: "Estate Agent"          
  ...
  jobRanks = {
    {
      grade = 0,
      name = "recruee",
      label = "Młodszy Doradca ds. Nieruchomości",
      salary = 15,
    },
    {
      grade = 1,
      name = "recruee",
      label = "Starszy Doradca ds. Nieruchomości",
      salary = 30,
    },
    {
      grade = 2,
      name = "boss",
      label = "Heaven Buildings - Prezes",
      salary = 45,
    },
  },
  Permissions = { -- Minimum Grade Required for Action
    ...
    ViewProperties = 1, -- View All Properties
    SellProperty = 1, -- Sell Property to players
    ToggleCCTV = 0, -- Change CCTV settings
    ...
    ResetFurniture = 1, -- Reset Furniture
...
Config.FurnitureStores = {
  {
    title = "Ikea",
    Catagories = {"Dekoracje", "Stoły", "Sofy", "Łóżka"}
  },
  {
    title = "Sklep Elektroniczny",
    Catagories = {"Elektryka","Kuchnia"}
  },
}
