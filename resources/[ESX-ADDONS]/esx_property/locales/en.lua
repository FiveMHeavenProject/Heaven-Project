Locales['en'] = {
	...
	["rot_left_right"] = "Lewo/Prawo",
	["rot_up_down"] = "Góra/Dół",
	["zoom"] = "Przybliż/Oddal",
	["zoom_level"] = "Przybliżenie: %s %%",
	["night_vision"] = "Włącz tryb podczerwieni",
	["clipboard"] = "Link zapisany do schowka",
	["picture_taken"] = "Zrobione zdjęcie!",
	["please_wait"] = "Musisz chwilę poczekać nim zrobisz następne zdjęcie",
	["exit"] = "Wyjście",
	...
	["height"] = "Wysokość",
	["rotate"] = "Obrót",
	["place"] = "Miejsce na mebel",
	["delete_furni"] = "Usuń",
	["confirm_buy"] = "Czy na pewno chcesz to kupić %s ?",
	["price"] = "Cena: %s$",
	["yes"] = "Tak",
	["no"] = "Nie",
	["action"] = "Ty %s ~b~%s~s~ !",
	["bought_furni"] = "Kupiłeś %s",
	["edited_furni"] = "Zmieniłeś %s",
	["cannot_buy"] = "Nie możesz tego kupić..",
	["cannot_edit"] = "Nie możesz tego edytować",
	["store_title"] = "Sklep - %s",
	["back"] = "Powrót",
	["edit_title"] = "Edytuj - %s",
	["move_title"] = "Rusz",
	["deleted_confirm"] = "Usuwanie %s~",
	["deleted_error"] = "Nie można usunąć %s",
	["owned_furni"] = "Posiadane meble",
	["menu_stores"] = "Flexform Sofas | Sklep meblowy",
	["menu_stores_desc"] = "Zakup mebel",
	["menu_reset"] = "Reset",
	["menu_reset_desc"] = "Wyczyść wszystkie meble",
	["menu_edit"] = "Edytuj",
	["menu_edit_desc"] = "Przesuń lub usuń mebel",
